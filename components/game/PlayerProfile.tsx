...
const REVIEWED_PRODUCTS = [
  ...
  { name: "AM Infinity .97", desc: "World's lightest hollow-out metal gaming mouse with infinite battery life.", tag: "MOUSE", href: "https://store.angrymiao.com/products/am-infinity-97-wireless-gaming-mouse", image: "/product/am-infinity.webp" },
